...
def test_analyze_text_response_has_required_laravel_fields():
    ...
    data = response.json()
    required = {"ok", "request_id", "transcript", "normalized_transcript", "provider", "expected_text", "is_correct", "similarity_label", "character_similarity", "token_similarity", "expected_phonemes", "actual_phonemes", "phoneme_similarity", "error_type", "feedback_hint", "coach_hint_key", "learner_safe_summary", "skill_signal", "recommended_practice_focus", "warnings", "error"}
