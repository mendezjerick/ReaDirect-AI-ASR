...
ERROR_FOCUS_MAP = {
    "final_sound_error": {
        ...
        "preferred_activity_types": ["display_word_reading", "highlighted_sentence_word"],
    ...
    "initial_sound_error": {
        ...
        "preferred_activity_types": ["display_word_reading", "first_letter_identification", "missing_first_letter"],
        "recommended_action": "remediate",
    ...
    "vowel_error": {
        ...
        "preferred_activity_types": ["display_word_reading", "split_word_reading", "highlighted_rhyme_word"],
        "recommended_action": "remediate",
    ...
    "consonant_error": {
        ...
        "preferred_activity_types": ["display_word_reading", "split_word_reading"],
        "recommended_action": "remediate",
    ...
    "skipped_word": {
        ...
        "preferred_activity_types": ["simple_sentence_reading", "full_stop_pause_reading"],
    ...
    "partial_sentence": {
        ...
        "preferred_activity_types": ["comma_pause_reading", "mixed_punctuation_fluency"],
        "recommended_action": "practice",
    ...
    "blank": {
        ...
        "preferred_activity_types": ["display_word_reading", "letter_pair_identification"],
    ...
    "far_answer": {
        ...
        "preferred_activity_types": ["display_word_reading", "simple_sentence_reading", "review"],
...
def map_error_to_focus(error_type: str, skill_signal: str | None = None) -> dict[str, object]:
    ...
    base = ERROR_FOCUS_MAP.get(
        normalized,
        {
            ...
            "preferred_activity_types": ["display_word_reading", "review"],
            "recommended_action": "practice",
