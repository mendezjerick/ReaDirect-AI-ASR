...
class TranscriptNormalizationResult:
    ...
    overall_gop_score: float | None = None
    ...
    canonical_expected_phonemes: list[str] | None = None
    gop_observed_phonemes: list[str] | None = None
    decoded_phonemes: list[str] | None = None
    decoded_acoustic_phonemes: list[str] | None = None
    gop_phoneme_scores: list[dict[str, Any]] | None = None
    phoneme_scores: list[dict[str, Any]] | None = None
    ...
    weak_phoneme_score: float | None = None
    lowest_phoneme: str | None = None
    lowest_phoneme_score: float | None = None
    nearest_confusion: str | None = None
    alignment_quality: str | None = None
    gop_model_version: str | None = None
    gop_model_path: str | None = None
    gop_frame_count: int | None = None
    gop_duration_seconds: float | None = None
    gop_fallback_used: bool | None = None
